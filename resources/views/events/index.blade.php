    ...
    <div class="events-page">
        ...
        <section class="page-hero">
            <div class="container">
                ...
                <a href="{{ route('events.create') }}" class="btn btn-primary">Share an Event</a>
            </div>
        </section>
            ...
            <div class="container">
                <div class="events-grid">
                    @forelse($events as $event)
                        <div class="event-card" data-type="{{ $event->event_type }}"
                            data-online="{{ $event->is_online ? 'online' : 'in-person' }}">
                            <div class="event-header">
                                <div class="event-date">
                                    <span class="date-day">{{ $event->event_date->format('d') }}</span>
                                    <span class="date-month">{{ $event->event_date->format('M') }}</span>
                                </div>
                                <span class="event-type">{{ ucfirst(str_replace('-', ' ', $event->event_type)) }}</span>
                            </div>
                            ...
                            <div class="event-footer">
                                <div class="event-author">
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($event->user->name) }}&background=6366F1&color=fff&size=32"
                                        alt="">
                                    <span>{{ $event->user->name }}</span>
                                </div>
                                <a href="{{ route('events.show', $event) }}" class="btn-link">Details →</a>
                            </div>
                        </div>
                    @empty
