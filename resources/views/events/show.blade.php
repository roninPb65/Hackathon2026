                ...
                <div class="hero-grid">
                    <div class="hero-main">
                        <div class="event-badges">
                            <span class="badge-type">{{ ucfirst(str_replace('-', ' ', $event->event_type)) }}</span>
                            @if ($event->is_online)
                    ...
                    @if ($event->url)
                        <div class="hero-actions">
                            <a href="{{ $event->url }}" target="_blank" class="btn btn-primary btn-large">Register Now</a>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="content-main">
                        ...
                        <div class="action-section">
                            ...
                            <form action="{{ route('actions.store') }}" method="POST">
                                ...
                                <input type="hidden" name="completed_at" value="{{ date('Y-m-d') }}">
                    ...
                    <aside class="content-sidebar">
                        <div class="sidebar-box">
                            ...
                            <div class="detail-list">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{{ $event->event_date->format('M d, Y') }}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Time</span>
                                    <span class="detail-value">{{ $event->event_date->format('g:i A') }}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Type</span>
                                    <span
                                        class="detail-value">{{ ucfirst(str_replace('-', ' ', $event->event_type)) }}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Format</span>
                                    <span class="detail-value">{{ $event->is_online ? 'Online' : 'In-Person' }}</span>
                                </div>
                            </div>
                            @if ($event->url)
                                <a href="{{ $event->url }}" target="_blank" class="btn btn-secondary btn-block">Visit
                                    Event Page</a>
                            @endif
                        </div>
                        ...
                        <div class="sidebar-box">
                            ...
                            <div class="user-profile">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($event->user->name) }}&background=6366F1&color=fff&size=60"
                                    alt="">
                                <div class="user-info">
                                    <div class="user-name">{{ $event->user->name }}</div>
                                    <div class="user-meta">{{ $event->created_at->diffForHumans() }}</div>
                                </div>
                            </div>
                        </div>
                    </aside>
