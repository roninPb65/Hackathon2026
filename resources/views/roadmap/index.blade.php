        ...
        <section class="roadmap-hero">
            <div class="container">
                ...
                <div class="hero-stats">
                    ...
                    <div class="stat-card">
                        <div class="stat-number">{{ $totalMilestones - $completedCount }}</div>
            ...
            <div class="container">
                ...
                <div class="phase-block">
                    ...
                    <div class="milestones-grid">
                        {{-- Milestone 1 --}}
                        <div
                            class="milestone-card {{ $userActions->where('action.category', 'resume')->count() > 0 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                ...
                                <div class="milestone-status">
                                    @if ($userActions->where('action.category', 'resume')->count() > 0)
                            ...
                            <div class="milestone-actions">
                                <a href="{{ route('chatbot.index') }}" class="action-btn primary">Use ATS Helper</a>
                                <a href="{{ route('resume.builder') }}" class="action-btn secondary">Build Resume</a>
                            </div>
                        </div>

                        {{-- Milestone 2 --}}
                        <div class="milestone-card {{ Auth::user()->skills->count() >= 5 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="milestone-status">
                                    @if (Auth::user()->skills->count() >= 5)
                                        <span class="status-badge completed">✓ Completed</span>
                                    @else
                                        <span class="status-badge pending">{{ Auth::user()->skills->count() }}/5</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="milestone-actions">
                                <a href="{{ route('skills.index') }}" class="action-btn primary">Add Skills</a>
                            </div>
                        </div>

                        {{-- Milestone 3 --}}
                        <div class="milestone-card {{ $userActions->count() >= 1 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                            ...
                            <div class="milestone-actions">
                                <a href="{{ route('actions.index') }}" class="action-btn primary">Browse Actions</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="phase-block">
                    ...
                    <div class="milestones-grid">
                        <div
                            class="milestone-card {{ $userActions->where('action.category', 'networking')->count() >= 2 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="milestone-status">
                                    @if ($userActions->where('action.category', 'networking')->count() >= 2)
                                        <span class="status-badge completed">✓ Completed</span>
                                    @else
                                        <span
                                            class="status-badge pending">{{ $userActions->where('action.category', 'networking')->count() }}/2</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <p class="milestone-description">Build connections through LinkedIn, events, or informational
                                interviews.</p>
                            <div class="milestone-actions">
                                <a href="{{ route('actions.index') }}" class="action-btn primary">Start Networking</a>
                            </div>
                        </div>

                        <div
                            class="milestone-card {{ $userActions->where('action.category', 'events')->count() >= 1 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="milestone-status">
                                    @if ($userActions->where('action.category', 'events')->count() >= 1)
                                        <span class="status-badge completed">✓ Completed</span>
                                    @else
                                        <span class="status-badge pending">Pending</span>
                                    @endif
                            ...
                            <div class="milestone-actions">
                                <a href="{{ route('events.index') }}" class="action-btn primary">Find Events</a>
                            </div>
                        </div>

                        <div
                            class="milestone-card {{ $userActions->where('action.category', 'skills')->count() >= 1 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="milestone-status">
                                    @if ($userActions->where('action.category', 'skills')->count() >= 1)
                                        <span class="status-badge completed">✓ Completed</span>
                                    @else
                                        <span class="status-badge pending">Pending</span>
                                    @endif
                ...
                <div class="phase-block">
                    ...
                    <div class="milestones-grid">
                        ...
                        <div
                            class="milestone-card {{ $userActions->where('action.category', 'networking')->count() >= 5 ? 'completed' : '' }}">
                            <div class="milestone-header">
                                <div class="milestone-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="milestone-status">
                                    ...
                                    @else
                                        <span
                                            class="status-badge pending">{{ $userActions->where('action.category', 'networking')->count() }}/5</span>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="phase-block">
                    ...
                    <div class="milestones-grid">
                        ...
                        <div class="milestone-card">
                            ...
                            <div class="milestone-actions">
                                <a href="{{ route('insights.create') }}" class="action-btn success">Share Your Story</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="cta-cards">
                        @if (Auth::user()->skills->count() < 5)
                            <div class="cta-card">
                                ...
                                <h3>Add Skills</h3>
                                <p>{{ 5 - Auth::user()->skills->count() }} more needed</p>
                                <a href="{{ route('skills.index') }}" class="cta-btn">Get Started</a>
                            </div>
                        @endif
                        ...
                        @if ($userActions->where('action.category', 'networking')->count() < 2)
                            <div class="cta-card">
                                ...
                                <a href="{{ route('actions.index') }}" class="cta-btn">Start Now</a>
                            </div>
                        @endif
                        ...
                        <div class="cta-card">
                            ...
                            <a href="{{ route('insights.index') }}" class="cta-btn">Explore</a>
                        </div>
                    </div>
                </div>
            </div>
