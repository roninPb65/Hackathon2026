{{-- resources/views/insights/show.blade.php --}}
@extends('layouts.app')

@section('title', $insight->job_title . ' - Success Story')

@section('content')
    <div class="insight-detail-page">
        <div class="container">
            <a href="{{ route('insights.index') }}" class="back-button">
                ← Back to Stories
            </a>
            ...
            <div class="insight-detail-container">
                ...
                <div class="hero-section">
                    <div class="hero-content">
                        <div class="user-profile">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($insight->user->name) }}&background=667eea&color=fff&size=120"
                                alt="{{ $insight->user->name }}" class="profile-avatar">
                            <div class="profile-info">
                                <h1 class="profile-name">{{ $insight->user->name }}</h1>
                                <h2 class="job-title">{{ $insight->job_title }}</h2>
                                @if ($insight->company)
                        ...
                        <div class="stats-badges">
                            <div class="stat-badge stat-time">
                                ...
                                <div class="badge-content">
                                    <span class="badge-number">{{ $insight->time_to_hire }}</span>
                                    <span class="badge-label">{{ Str::plural('Month', $insight->time_to_hire) }}</span>
                                </div>
                            </div>
                            <div class="stat-badge stat-date">
                                ...
                                <div class="badge-content">
                                    ...
                                    <span class="badge-text">{{ $insight->created_at->format('M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-layout">
                        ...
                        @if (is_array($insight->key_actions) && count($insight->key_actions) > 0)
                            <div class="actions-section">
                                ...
                                <div class="actions-grid">
                                    @foreach ($insight->key_actions as $action)
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-card insights-card">
                            ...
                            <div class="insight-items">
                                <div class="insight-item">
                                    ...
                                    <span class="insight-value">{{ $insight->time_to_hire }}
                                        {{ Str::plural('month', $insight->time_to_hire) }}</span>
                                </div>
                                <div class="insight-item">
                                    <span class="insight-label">Key Actions Used</span>
                                    <span
                                        class="insight-value">{{ is_array($insight->key_actions) ? count($insight->key_actions) : 0 }}
                                        strategies</span>
                                </div>
                                <div class="insight-item">
                                    <span class="insight-label">Position</span>
                                    <span class="insight-value">{{ $insight->job_title }}</span>
                                </div>
                                @if ($insight->company)
                                    <div class="insight-item">
                                        <span class="insight-label">Company</span>
                                        <span class="insight-value">{{ $insight->company }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="sidebar-card action-card">
                            ...
                            <a href="{{ route('actions.index') }}" class="card-btn">
                        ...
                        <div class="sidebar-card">
                            ...
                            <a href="{{ route('insights.index') }}" class="card-btn-secondary">
                                Browse All Stories
                            </a>
                        </div>
                    </div>
                ...
                <div class="cta-section">
                    <div class="cta-content">
                        ...
                        <a href="{{ route('insights.create') }}" class="btn btn-cta">
                            💼 Share Your Story
                        </a>
                    </div>
                </div>
    ...
    <script>
        function shareOnTwitter() {
            const text = "Check out this inspiring career success story from {{ $insight->user->name }}! 🌟";
