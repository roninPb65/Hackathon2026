<?php $__env->startSection('title', 'Share Your Success Story'); ?>
        ...
        <div class="form-section-wrapper">
            <div class="container">
                ...
                <div class="form-container">
                    <form action="<?php echo e(route('insights.store')); ?>" method="POST" class="insight-form">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="job_title" name="job_title"
                                        class="form-input <?php $__errorArgs = ['job_title'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company" name="company"
                                        class="form-input <?php $__errorArgs = ['company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="Optional - Keep anonymous if preferred" value="<?php echo e(old('company')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select id="time_to_hire" name="time_to_hire"
                                    class="form-input <?php $__errorArgs = ['time_to_hire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="1" <?php echo e(old('time_to_hire') == 1 ? 'selected' : ''); ?>>Less than 1
                                        month</option>
                                    <option value="2" <?php echo e(old('time_to_hire') == 2 ? 'selected' : ''); ?>>1-2 months
                                    </option>
                                    <option value="3" <?php echo e(old('time_to_hire') == 3 ? 'selected' : ''); ?>>2-3 months
                                    </option>
                                    <option value="4" <?php echo e(old('time_to_hire') == 4 ? 'selected' : ''); ?>>3-4 months
                                    </option>
                                    <option value="6" <?php echo e(old('time_to_hire') == 6 ? 'selected' : ''); ?>>4-6 months
                                    </option>
                                    <option value="9" <?php echo e(old('time_to_hire') == 9 ? 'selected' : ''); ?>>6-9 months
                                    </option>
                                    <option value="12" <?php echo e(old('time_to_hire') == 12 ? 'selected' : ''); ?>>9-12 months
                                    </option>
                                    <option value="18" <?php echo e(old('time_to_hire') == 18 ? 'selected' : ''); ?>>12+ months
                                    </option>
                                </select>
                                <?php $__errorArgs = ['time_to_hire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="actions-grid">
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Networking events"
                                        <?php echo e(in_array('Networking events', old('key_actions', [])) ? 'checked' : ''); ?>>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="LinkedIn connections"
                                        <?php echo e(in_array('LinkedIn connections', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">💼</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Informational interviews"
                                        <?php echo e(in_array('Informational interviews', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">☕</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Online courses"
                                        <?php echo e(in_array('Online courses', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🎓</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Portfolio projects"
                                        <?php echo e(in_array('Portfolio projects', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">💻</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Resume optimization"
                                        <?php echo e(in_array('Resume optimization', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">📄</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Referrals"
                                        <?php echo e(in_array('Referrals', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🎯</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Career fairs"
                                        <?php echo e(in_array('Career fairs', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🎪</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Cold applications"
                                        <?php echo e(in_array('Cold applications', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">📮</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Volunteer work"
                                        <?php echo e(in_array('Volunteer work', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🌱</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Personal website"
                                        <?php echo e(in_array('Personal website', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🌐</span>
                                ...
                                <label class="action-checkbox">
                                    <input type="checkbox" name="key_actions[]" value="Skill certifications"
                                        <?php echo e(in_array('Skill certifications', old('key_actions', [])) ? 'checked' : ''); ?>>
                                    <span class="checkbox-card">
                                        <span class="checkbox-icon">🏅</span>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                <textarea id="success_story" name="success_story" class="form-textarea <?php $__errorArgs = ['success_story'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
• What advice would you give to others?"
                                    required><?php echo e(old('success_story')); ?></textarea>
                                <?php $__errorArgs = ['success_story'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            <a href="<?php echo e(route('insights.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hackathon\VibeTribe\resources\views/insights/create.blade.php ENDPATH**/ ?>