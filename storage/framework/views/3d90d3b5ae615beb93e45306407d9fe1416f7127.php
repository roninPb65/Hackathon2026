                    ...
                    <div class="resources-sidebar">
                        ...
                        <div class="resource-card">
                            ...
                            <div class="skills-container">
                                <?php if($technicalSkills->count() > 0): ?>
                                        ...
                                        <div class="skill-pills">
                                            <?php $__currentLoopData = $technicalSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button class="skill-pill"
                                                    onclick="addToResume('skill', '<?php echo e($skill->name); ?>', 'technical')">
                                ...
                                <?php if($softSkills->count() > 0): ?>
                                    <div class="skill-category">
                                        <h4>Soft Skills</h4>
                                        <div class="skill-pills">
                                            <?php $__currentLoopData = $softSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button class="skill-pill"
                                                    onclick="addToResume('skill', '<?php echo e($skill->name); ?>', 'soft')">
                                                    <span><?php echo e($skill->name); ?></span>
                                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2">
                                                        <line x1="12" y1="5" x2="12" y2="19">
                                ...
                                <?php if($industrySkills->count() > 0): ?>
                                    <div class="skill-category">
                                        <h4>Industry</h4>
                                        <div class="skill-pills">
                                            <?php $__currentLoopData = $industrySkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button class="skill-pill"
                                                    onclick="addToResume('skill', '<?php echo e($skill->name); ?>', 'industry')">
                                                    <span><?php echo e($skill->name); ?></span>
                                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2">
                                                        <line x1="12" y1="5" x2="12" y2="19">
                                ...
                                <?php if($userSkills->count() == 0): ?>
                                    <div class="empty-state">
                                        ...
                                        <a href="<?php echo e(route('skills.index')); ?>" class="link-btn">Add Skills →</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="actions-container">
                                <?php $__empty_1 = true; $__currentLoopData = $userActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userAction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="action-card"
                                        onclick="convertToResumeBullet(<?php echo e($userAction->id); ?>, '<?php echo e(addslashes($userAction->action->title)); ?>')">
                                        <div class="action-content">
                                            <h5><?php echo e(Str::limit($userAction->action->title, 50)); ?></h5>
                                            <span class="action-date"><?php echo e($userAction->completed_at->format('M Y')); ?></span>
                                        </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="empty-state">
                                        ...
                                        <a href="<?php echo e(route('actions.index')); ?>" class="link-btn">Browse Actions →</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hackathon\VibeTribe\resources\views/resume/builder.blade.php ENDPATH**/ ?>